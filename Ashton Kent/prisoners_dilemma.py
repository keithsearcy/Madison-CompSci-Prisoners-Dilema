...
def play_round(player1, player2, history1, history2, score1, score2):
    ...
    RELEASE = 100 # (R) when both players collude
    TREAT = 200 # (T) when you betray your partner
    SEVERE_PUNISHMENT = -100 # (S) when your partner betrays you
    PUNISHMENT = -200 # (P) when both players betray each other
